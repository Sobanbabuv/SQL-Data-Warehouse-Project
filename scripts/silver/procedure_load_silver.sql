...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			prd_id,
			REPLACE(SUBSTRING(prd_key, 1, 5), '-', '_') cat_key,-- Extract category ID
		...
		PRINT '=================================================';
		PRINT 'Silver Layer Completed, Total Load Duration:' + CAST(DATEDIFF(SECOND, @batch_start_time, @batch_end_time) AS VARCHAR) + 'Seconds';
		PRINT '=================================================';
